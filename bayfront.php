...
include('header.php'); ?>
			...
			<section class="page_title translucent_bg_purple image_fixed image_bg_8 t_align_c relative wrapper">
				<div class="container">
					<h1 class="color_light fw_light m_bottom_5">Bayfront</h1>
				</div>
			</section>
		<div class="container">		
			<div class="row">&nbsp;</div>
			...
			<!-- <h5 class="color_dark fw_light m_bottom_15 t_align_c" data-appear-animation="bounceInLeft">Choose a Condo to Discover Your Value Information</h5> -->
				<h5 class="fw_light m_bottom_15 t_align_c" data-appear-animation="bounceInLeft">Choose a Condo to Discover Your Value Information</h5>
